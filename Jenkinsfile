pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                script {
                    echo " Building frontend Docker image: ${env.IMAGE_NAME}:${env.IMAGE_TAG}"
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        docker run --rm -d --name test-frontend-${env.BUILD_NUMBER} -p 8081:80 ${env.IMAGE_NAME}:${env.IMAGE_TAG}
                        sleep 5
    ...
    post {
        ...
        success {
            ...
            echo " Frontend source code built and pushed: ${env.IMAGE_NAME}:${env.IMAGE_TAG}"
